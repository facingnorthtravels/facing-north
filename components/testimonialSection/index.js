    ...
    >
      <div className={classes.top_section}>
        ...
        <h1
          ...
          style={{ textAlign: isWhite ? "center" : "left" }}
        >
          Travel Tales
        </h1>
        <div className={classes.card_section}>
          <Slider arrows={true} {...settings}>
            {TESTIMONIALS?.map((testimonial, index) => (
              ...
              >
                <img src={testimonial?.img} style={{
                  objectPosition:  testimonial?.imgPosition || "center",
                }} />
                <div
                  className={classes.slide_content_container}
                  style={{ backgroundColor: isWhite && "#f7f7f7" }}
                >
                  <img
                    style={{
                      height: "fit-content",
                      objectFit: "contain",
                      width: width > 600 ? "10%" : "8%",
                  ...
                  <p className={classes.person_name}>{testimonial.name}</p>
                </div>
              </div>
            ))}
          </Slider>
